...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="main_text">
            <?php
            $articles = $contentManager->getStatti();
    ...
    <div class='footer'>
        <?php echo "<p style='text-align:right;font-size:12px; color:white;margin:10px;'>".$site_name."</p>"; ?>
    </div>
</div>
</body>
...
<!--                        <td class='td_top'>-->
<!--                            <h5><a title='--><?php //echo $row['title']; ?><!--' href='view_text.php?id=--><?php //echo $row['id']; ?><!--'>--><?php //echo $row['title']; ?><!--</a></h5>-->
<!--                            Дата добавления: --><?php //echo $row['date_added']; ?>
<!--                        </td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td>-->
